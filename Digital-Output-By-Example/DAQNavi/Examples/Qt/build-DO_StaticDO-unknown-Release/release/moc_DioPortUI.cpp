...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DioPortUI_t, stringdata) + ofs \
...
void DioPortUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DioPortUI::*_t)(QObject * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DioPortUI::stateChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DioPortUI::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DioPortUI.data,
      qt_meta_data_DioPortUI,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DioPortUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DioPortUI.stringdata))
        return static_cast<void*>(const_cast< DioPortUI*>(this));
