...
#include "G:/My_code/PA/poweramp.h"
...
QT_MOC_LITERAL(1, 9, 10), // "errorOccur"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 11), // "errorString"
QT_MOC_LITERAL(4, 33, 11), // "handleError"
QT_MOC_LITERAL(5, 45, 28), // "QSerialPort::SerialPortError"
QT_MOC_LITERAL(6, 74, 5) // "error"

    },
    "PowerAmp\0errorOccur\0\0errorString\0"
...
void PowerAmp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->errorOccur((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PowerAmp::errorOccur)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void PowerAmp::errorOccur(QString _t1)
{
